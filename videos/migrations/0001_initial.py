    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='videos.Comment', verbose_name='Comment parent')),
            ],
        ),
        migrations.CreateModel(
            name='CommentVote',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videos.Video', verbose_name='Video voted on')),
                ('voter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='User who voted on video')),
            ],
        ),
        migrations.CreateModel(
            name='ViewCount',
        ...
        migrations.AddField(
            model_name='video',
            name='votes',
            field=models.ManyToManyField(related_name='liked_videos', through='videos.VideoVote', to=settings.AUTH_USER_MODEL, verbose_name='Users who liked video'),
        ),
        migrations.AddField(
            model_name='comment',
            name='video',
        ...
        migrations.AddField(
            model_name='comment',
            name='votes',
            field=models.ManyToManyField(related_name='comments_voted_on', through='videos.CommentVote', to=settings.AUTH_USER_MODEL, verbose_name='User votes on comment'),
        ),
        ...
        migrations.AlterUniqueTogether(
            name='videovote',
            unique_together=set([('video', 'voter')]),
        ),
        migrations.AlterUniqueTogether(
            name='commentvote',
